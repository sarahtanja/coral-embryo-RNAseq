...
This result suggests that stage:leachate effects are **minimal** or
**limited to a small subset of genes**.
...
early gastrula stage in the high leachate treatment when compared to the
control. All 27 of these genes had more abundant transcripts in treated
...
DEGs.\
- DEGreport vignette,
[degPatterns](https://www.bioconductor.org/packages/release/bioc/vignettes/DEGreport/inst/doc/DEGreport.html#:~:text=%22expression%22)-,Detect%20patterns%20of%20expression,-In%20this%20section)
...
Group 1 peak at earlygastrula Group 2 peak at prawnchip Group 3 peak at
cleavage Save the gene cluster annotation
