...
Our design includes: - Main effects for stage and leachate - Interaction terms between stage and leachate

The levels are: - stage: cleavage, prawnchip, earlygastrula - leachate: control, low, mid, high

DESeq2 uses reference coding, so: - cleavage is the reference for stage - control is the reference for leachate - Therefore, interaction terms are the additional effects relative to cleavage + control
