...
# Leachate: continuous vs categorical
...
|-----------|---------------------------------------------|------------------------|------------------------------------------------------------|
| `dds_cat` | `stage + leachate + stage:leachate`         | `stage + leachate`     | Are there **stage-specific effects of leachate (factor)**? |
| `dds_con` | `stage + leachate_mgL + stage:leachate_mgL` | `stage + leachate_mgL` | Are there **stage-specific trends** in dose response?      |
