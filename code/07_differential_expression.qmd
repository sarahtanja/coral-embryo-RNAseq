...
# [Likelihood Ratio Test](https://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html#likelihood-ratio-test), Wald
...
prawnchip_low_vs_mid <- as.data.frame(subset(prawnchip_low_vs_mid, padj<0.05))

prawnchip_low_vs_mid$contrast <- c('prawnchip_low_vs_mid')
prawnchip_low_vs_mid$gene <- rownames(prawnchip_low_vs_mid)
rownames(prawnchip_low_vs_mid) <- NULL

prawnchip_low_vs_mid
```
