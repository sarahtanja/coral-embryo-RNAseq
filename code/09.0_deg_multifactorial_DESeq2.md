...
To get the effect of leachate at a specific time: \| What you want \|
Use this contrast \| \| ———————— \| —————————————————- \| \| Low vs
Control at 4 hpf \| `"leachate_low_vs_control"` \| \| Low vs Control at
9 hpf \| `c("leachate_low_vs_control", "hpf9.leachatelow")` \| \| Mid vs
Control at 14 hpf \| `c("leachate_mid_vs_control", "hpf14.leachatemid")`
\| \| High vs Control at 9 hpf \|
