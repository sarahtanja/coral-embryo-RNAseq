...
reducedTerms.1 <- read_csv("../../output/08_go/reducedTerms_1.csv")
reducedTerms.2 <- read_csv("../../output/08_go/reducedTerms_2.csv")
reducedTerms.3 <- read_csv("../../output/08_go/reducedTerms_3.csv")

### Contrasts
reducedTerms.lvccl <- read_csv("../../output/08_go/reducedTerms_lvccl.csv")
reducedTerms.mvccl <- read_csv("../../output/08_go/reducedTerms_mvccl.csv")
reducedTerms.hvccl <- read_csv("../../output/08_go/reducedTerms_hvccl.csv")
reducedTerms.hvceg <- read_csv("../../output/08_go/reducedTerms_hvceg.csv")

## Similarity matrices
### Interaction
simMatrix.int <- read_csv("../../output/08_go/simMatrix_int.csv") %>% 
  column_to_rownames("GO") %>%  # uses the GO column as rownames
  as.data.frame()
