---
title: "Step 9: Multivariate Differential Gene Expression"
subtitle: "Following MarineOmics Functional Genomics Tutorial step-by-step`"
author: "Sarah Tanja"
date: 2024-12-02
date-modified: today
format:
...
```{r}
# Summarize differential expression attributed to interaction term
...
```{r}
plotMD(nl_hpf9_leachate_2_int)
```

```{r}
plotMD(is.de_nl_hpf14_leachate_2_int)
```
...
```{r}
write_csv(lrt_filt, "../output/09_deg_multifactorial/lrt_filt.csv")
```
...
ggsave("../output/09_deg_multifactorial/volcano_plot.png", width = 8, height = 6, dpi = 300)
...
# Save to CSV
write_csv(deg_gene_list, "../output/09_deg_multifactorial/deg_gene_list.csv")
```
