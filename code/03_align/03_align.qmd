...
for file in ../output/03_qaqc/trimmed_reads/*[CLMH]4_R2_001.fastp-trim.fq.gz
do
...
do
  ...
  /home/shared/hisat2-2.2.1/hisat2 \
    ...
    2> ../output/04_align/hisat/"${sample_name}_hisat.out" 
done
```
...
for samfile in ../output/04_align/sam/*[CLMH]4.sam; do 
...
Visualize stuff on [igv.org](https://igv.org/) ? Figure this out one day....
...
```{r, engine='bash'}
find ../output/04_align/bam/*[CLMH]4.sorted.bam \
