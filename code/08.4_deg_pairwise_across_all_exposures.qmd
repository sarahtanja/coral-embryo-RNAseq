...
> 🤔 Why might you get zero significant genes?
Here are common reasons:
- Weak or no true signal: The effect size may be small, or there’s genuinely no strong differential expression.
- Insufficient power: Not enough replicates or high within-group variability.
- Wrong contrast or factor levels: If you’re not testing the right comparison, you might get no signal.
- Batch effects / confounding: Noise can drown out signal if not modeled properly.