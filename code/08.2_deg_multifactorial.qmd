...
Ok we're going to use our `gcm_filt_or` as our prefiltered and outlier removed gene count matrix from here out
...
::: callout-important
3 genes had likelihood of non-linear effect (p \< 0.1) as identified by LRT
:::
