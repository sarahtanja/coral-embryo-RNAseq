...
stage.colors <- c(cleavage = "#FFE362", 
                  prawnchip = "#EBA600", 
                  earlygastrula = "#8D5300")
```
...
PCA_500 <- ggplot(pca_500, aes(PC1, PC2, color = stage, label = label)) +
  ...
  coord_fixed() +
  scale_color_manual(values = stage_4) +
  theme_minimal()+
...
PCA_500_leachate <- ggplot(pca_500_or, aes(PC1, PC2, color = leachate, label = name)) +
  ...
  ylab(paste0("PC2: ", percentVar_500[2], "% variance")) + 
  coord_fixed() +
  scale_color_manual(values = leachate_4) +
...
PCA_500_spawnnight <- ggplot(pca_500_or, aes(PC1, PC2, color = spawn_night, label = name)) +
  ...
  ylab(paste0("PC2: ", percentVar_500[2], "% variance")) + 
  coord_fixed() +
  scale_color_manual(values = night_2) +
